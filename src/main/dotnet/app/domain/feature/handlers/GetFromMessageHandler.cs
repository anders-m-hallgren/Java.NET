...
{
    public class GetFromMessageHandler : IRequestHandler<GetFromCache, string>
    {
        private readonly ILogger<GetFromCacheHandler> _logger;
        private readonly IDistributedCache _cache;

        public GetFromMessageHandler(ILogger<GetFromCacheHandler> logger, IDistributedCache cache)
        {
            _logger = logger;
            _cache = cache;
        }
